...
model_labels_path1 = 'Output/mlp_12_negri_21-03-2025_15:23/labels/labeled_epoch_48.npy'
...
# Plot bars
plt.bar(r1, accuracy_list, color='salmon', width=bar_width, label='No Lag Threshold')
plt.bar(r2, accuracy_list1, color='purple', width=bar_width, label='Lag Threshold = 0.8')
