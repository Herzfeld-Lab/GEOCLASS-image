...
model_labels_path1 = '15 classes output/VarioMLP_lag_thresh/mlp_test_negri_04-03-2025_15:42/labels/full_labeled_epoch_35.npy'
...
plt.bar(r2, accuracy_list1, color='purple', width=bar_width, label='Lag Threshold of 0.8')
